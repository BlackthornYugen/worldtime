...
- **Terminal ANSI Color-Coding**: Visually colors hourly cells to categorize parts of the day (Yellow for work hours, Light Blue/Cyan for transition hours, and Dark Blue for night).
  ...
  * **Hour-Only Formatting & Grid Shifting**: Timelines show hours only (e.g. `15` instead of `15:00`) centered inside columns. For timezones offset by 30 minutes, the entire grid of separators `│` is shifted to the right by 4 spaces, aligning them exactly in the middle of standard columns.
  > [!NOTE]
