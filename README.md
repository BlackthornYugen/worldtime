...
- **Dynamic Format Negotiation**: Automatically detects `curl` requests or `Accept: text/plain` headers to render plain text tables, while returning a beautiful SPA to standard browsers.
