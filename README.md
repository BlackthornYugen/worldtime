...
- **Terminal ANSI Color-Coding**: Visually colors hourly cells to categorize parts of the day (Yellow for work hours, Light Blue/Cyan for transition hours, and Dark Blue for night).
  ...
  * **Hour-Only Formatting**: Timelines show hours only (e.g. `15` instead of `15:00`) centered inside columns. Timezones offset by 30 minutes are shifted by 3 spaces to visually align them in the middle of standard columns.
  > [!NOTE]
